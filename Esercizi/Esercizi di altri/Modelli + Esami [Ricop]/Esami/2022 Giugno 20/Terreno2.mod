...
subject to Bilanciamento1 {r in R, c in C}:
  sum {i in R, j in C} x[i,j,r,c] - sum {i in R, j in C} x[r,c,i,j] + q[r,c] <= U;
subject to Bilanciamento2 {r in R, c in C}:
  sum {i in R, j in C} x[i,j,r,c] - sum {i in R, j in C} x[r,c,i,j] + q[r,c] >= L;
