#ESERCIZIO 4.4 PL - Investimenti

#DATI
param nMercati;					# Numero mercati
param nFondi;					# Numero fondi
param nAzioni;					# Numero azioni
param nCapitali;				# Numero capitali
...
param rendimentoFondo {mercati,fondi}; #[%] NB: i fondi sono entità diverse per ogni mercato
param maxAcquistabile {mercati,azioni}; #[mln€] NB: i fondi sono entità diverse per ogni mercato
param composizioneFondi {mercati,fondi,azioni}; #[%] azioni presenti in ogni fondo di ogni mercato
...
subject to massimo_capitali:
	sum {m in mercati,f in fondi} investimenti[m,f] <= sum {c in capitali} composizioneCapitali[c];
