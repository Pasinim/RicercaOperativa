#ESERCIZIO 37 - PNL Classificatore automatico (Versione 2)
...
#minimize z1: sum {i in P} w[i];

#Vogliamo massimizzare la minimia tra tutte le distanze (MaxMin)
maximize z2: delta; 
subject to No_Peggioramento: sum {i in P} w[i] = 5;		# 5 e' il valore ottimo <<z1*>>
