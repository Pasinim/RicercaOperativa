# TERZA VERSIONE:Considerare inoltre la versione in cui esiste un costo di attivazione per ogni magazzino, diverso a seconda di dove esso viene localizzato, ed un budget complessivo disponibile per sostenere tali costi.
#DATI
